...
class RahulSinghGuard(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.pnl = 0.0  
        self.balance = 100000.0 # Dummy Practice Money
        self.loss_limit = -2000.0 # Rahul Singh protection limit
    ...
    def process_trade(self, instance):
        # Simulation: Loss protection logic
        self.pnl -= 1000.0 
        self.balance -= 1000.0
        ...
        if self.pnl <= self.loss_limit:
            ...
            self.trade_btn.disabled = True # Over-trading blocked
        else:
            self.status.text = "Rahul Singh: Trade done. Be careful!"
